...
set_instance_parameter_value mxfe_rx_jesd204 {LANE_MAP} {13 10 11 9 3 15 12 14 2 5 0 4 8 7 6 1}
...
set_instance_parameter_value quadmxfe_tx_jesd204 {LANE_MAP} {13 8 9 7 3 15 12 14 6 5 2 4 0 10 1 11}
...
add_instance spi_2 altera_avalon_spi
set_instance_parameter_value spi_2 {clockPhase} {0}
set_instance_parameter_value spi_2 {clockPolarity} {0}
set_instance_parameter_value spi_2 {dataWidth} {8}
set_instance_parameter_value spi_2 {masterSPI} {1}
set_instance_parameter_value spi_2 {numberOfSlaves} {2}
set_instance_parameter_value spi_2 {targetClockRate} {10000000.0}
add_interface spi_2 conduit end
set_interface_property spi_2 EXPORT_OF spi_2.external

# Quad MxFE gpio

add_instance mxfe_pio altera_avalon_pio
set_instance_parameter_value mxfe_pio {direction} {InOut}
set_instance_parameter_value mxfe_pio {generateIRQ} {1}
set_instance_parameter_value mxfe_pio {width} {64}
set_instance_parameter_value mxfe_pio {edgeType} {RISING}
add_interface mxfe_pio conduit end
set_interface_property mxfe_pio EXPORT_OF mxfe_pio.external_connection
...
add_connection sys_clk.clk spi_2.clk
add_connection sys_clk.clk mxfe_pio.clk
...
add_connection sys_clk.clk_reset spi_2.reset
add_connection sys_clk.clk_reset mxfe_pio.reset
...
if {$RX_NUM_OF_LANES > 8 } {ad_cpu_interconnect 0x00010000 avl_adxcfg_8.rcfg_s0     "avl_mm_bridge_0"}
if {$RX_NUM_OF_LANES > 9 } {ad_cpu_interconnect 0x00012000 avl_adxcfg_9.rcfg_s0     "avl_mm_bridge_0"}
if {$RX_NUM_OF_LANES > 10} {ad_cpu_interconnect 0x00014000 avl_adxcfg_10.rcfg_s0    "avl_mm_bridge_0"}
if {$RX_NUM_OF_LANES > 11} {ad_cpu_interconnect 0x00016000 avl_adxcfg_11.rcfg_s0    "avl_mm_bridge_0"}
if {$RX_NUM_OF_LANES > 12} {ad_cpu_interconnect 0x00018000 avl_adxcfg_12.rcfg_s0    "avl_mm_bridge_0"}
if {$RX_NUM_OF_LANES > 13} {ad_cpu_interconnect 0x0001A000 avl_adxcfg_13.rcfg_s0    "avl_mm_bridge_0"}
if {$RX_NUM_OF_LANES > 14} {ad_cpu_interconnect 0x0001C000 avl_adxcfg_14.rcfg_s0    "avl_mm_bridge_0"}
if {$RX_NUM_OF_LANES > 15} {ad_cpu_interconnect 0x0001E000 avl_adxcfg_15.rcfg_s0    "avl_mm_bridge_0"}
...
if {$TX_NUM_OF_LANES > 8}  {ad_cpu_interconnect 0x00010000 avl_adxcfg_8.rcfg_s1     "avl_mm_bridge_1"}
if {$TX_NUM_OF_LANES > 9}  {ad_cpu_interconnect 0x00012000 avl_adxcfg_9.rcfg_s1     "avl_mm_bridge_1"}
if {$TX_NUM_OF_LANES > 10} {ad_cpu_interconnect 0x00014000 avl_adxcfg_10.rcfg_s1    "avl_mm_bridge_1"}
if {$TX_NUM_OF_LANES > 11} {ad_cpu_interconnect 0x00016000 avl_adxcfg_11.rcfg_s1    "avl_mm_bridge_1"}
if {$TX_NUM_OF_LANES > 12} {ad_cpu_interconnect 0x00018000 avl_adxcfg_12.rcfg_s1    "avl_mm_bridge_1"}
if {$TX_NUM_OF_LANES > 13} {ad_cpu_interconnect 0x0001A000 avl_adxcfg_13.rcfg_s1    "avl_mm_bridge_1"}
if {$TX_NUM_OF_LANES > 14} {ad_cpu_interconnect 0x0001C000 avl_adxcfg_14.rcfg_s1    "avl_mm_bridge_1"}
if {$TX_NUM_OF_LANES > 15} {ad_cpu_interconnect 0x0001E000 avl_adxcfg_15.rcfg_s1    "avl_mm_bridge_1"}
...
ad_cpu_interconnect 0x000E0000 spi_2.spi_control_port
ad_cpu_interconnect 0x000E2000 mxfe_pio.s1
...
ad_cpu_interrupt 15  spi_2.irq
ad_cpu_interrupt 16  mxfe_pio.irq
