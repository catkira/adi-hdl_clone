...
set_location_assignment  -name IO_STANDARD "1.8V" -to adf4371_cs[0]
set_location_assignment  -name IO_STANDARD "1.8V" -to adf4371_cs[1]
set_location_assignment  -name IO_STANDARD "1.8V" -to adf4371_cs[2]
set_location_assignment  -name IO_STANDARD "1.8V" -to adf4371_cs[3]
set_location_assignment  -name IO_STANDARD "1.8V" -to adf4371_sclk
set_location_assignment  -name IO_STANDARD "1.8V" -to adf4371_sdio
set_location_assignment  -name IO_STANDARD "1.8V" -to adrf5020_ctrl
...
set_location_assignment  -name IO_STANDARD LVDS -to fpga_clk_m2c[0]
set_location_assignment  -name IO_STANDARD LVDS -to fpga_clk_m2c[1]
set_location_assignment  -name IO_STANDARD LVDS -to fpga_clk_m2c[2]

set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_0_n
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_1_n
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_2_n
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_3_n

set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_0_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_1_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_2_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_3_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_4_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_5_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_6_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncin_7_p

set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_0_n
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_1_n
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_2_n
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_3_n

set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_0_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_1_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_2_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_3_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_4_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_5_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_6_p
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_syncout_7_p

set_location_assignment  -name INPUT_TERMINATION DIFFERENTIAL -to fpga_clk_m2c[1]
set_location_assignment  -name INPUT_TERMINATION DIFFERENTIAL -to fpga_clk_m2c[2]
...
set_location_assignment  -name IO_STANDARD "1.8V"  -to hmc425a_v[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to hmc425a_v[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to hmc425a_v[3]
set_location_assignment  -name IO_STANDARD "1.8V"  -to hmc425a_v[4]
...
set_location_assignment  -name IO_STANDARD "1.8V"  -to hmc7043_gpio
set_location_assignment  -name IO_STANDARD "1.8V"  -to hmc7043_reset
set_location_assignment  -name IO_STANDARD "1.8V"  -to hmc7043_sclk
set_location_assignment  -name IO_STANDARD "1.8V"  -to hmc7043_sdata
set_location_assignment  -name IO_STANDARD "1.8V"  -to hmc7043_slen
...
set_location_assignment  PIN_BE31  -to mxfe_rx_en0[0]       ; ## G36  LA33_P
...
set_location_assignment  PIN_BD31  -to mxfe_rx_en1[0]       ; ## G37  LA33_N
...
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_cs[0]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_cs[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_cs[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_cs[3]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_miso[0]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_miso[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_miso[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_miso[3]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_mosi[0]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_mosi[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_mosi[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_mosi[3]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_reset[0]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_reset[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_reset[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_reset[3]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_rx_en0[0]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_rx_en0[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_rx_en0[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_rx_en0[3]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_rx_en1[0]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_rx_en1[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_rx_en1[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_rx_en1[3]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_sclk[0]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_sclk[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_sclk[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_sclk[3]
...
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_tx_en0[0]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_tx_en0[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_tx_en0[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_tx_en0[3]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_tx_en1[0]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_tx_en1[1]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_tx_en1[2]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe_tx_en1[3]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe0_gpio[0] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe0_gpio[1] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe0_gpio[2] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe0_gpio[3] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe0_gpio[4] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe0_gpio[5] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe0_gpio[6] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe0_gpio[7] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe0_gpio[8] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe1_gpio[0] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe1_gpio[1] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe1_gpio[2] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe1_gpio[3] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe1_gpio[4] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe1_gpio[5] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe1_gpio[6] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe1_gpio[7] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe1_gpio[8] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe2_gpio[0] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe2_gpio[1] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe2_gpio[2] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe2_gpio[3] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe2_gpio[4] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe2_gpio[5] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe2_gpio[6] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe2_gpio[7] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe2_gpio[8] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe3_gpio[0] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe3_gpio[1] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe3_gpio[2] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe3_gpio[3] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe3_gpio[4] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe3_gpio[5] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe3_gpio[6]
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe3_gpio[7] 
set_location_assignment  -name IO_STANDARD "1.8V"  -to mxfe3_gpio[8] 
